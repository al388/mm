...
if X == 1 :
	try:
		requests.post(f"https://api.telegram.org/bot2093822968:AAHWN4WaI2Oykbvat7393jECzpTnYx59Lrg/sendMessage?chat_id={ic}&text=HI\nIf you have a problem tell me\nINSTA : @DAN_MTGR | TELE : @DA_HERE")
	except:
		print("[!] Try with VPN ")
		input("")
		exit()
...
print("""\033[0;97m𝑲𝒊𝒏𝒈 𝑫𝒂𝒏\n𝑰𝑵𝑺𝑻𝑨 : @𝑫𝑨𝑵_𝑴𝑻𝑮𝑹\n\033[1;34m𝐈𝐟 𝐲𝐨𝐮 𝐡𝐚𝐯𝐞 𝐚 𝐩𝐫𝐨𝐛𝐥𝐞𝐦, 𝐭𝐞𝐥𝐥 𝐦𝐞 𝐨𝐧 𝐈𝐧𝐬𝐭𝐚𝐠𝐫𝐚𝐦""")
print("\033[1;30m[\033[0;37m$\033[1;30m] \033[1;32mADD ME IN INSTA @DOOM.OLD")
def ops ():
	print('\n'+'\033[1;30m='*20+'\n')
